...
define(['angularAMD'], function (angularAMD) {
    ...
    angularAMD.factory('BaseController', ['$http', '$rootScope', '$log','$state', '$translate', 
      function ($http, $rootScope, $log, $state, $translate) {
        ...
        return {
            ...
            showWarningMessage: function( title, message ){
                alert($translate.instant(message), $translate.instant(title));
            },
